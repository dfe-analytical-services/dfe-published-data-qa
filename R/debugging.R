...
datafile <- debugReadFile("C:/R_Projects/dfe-published-data-qa/tests/testthat/mainTests/indicator_dp_nonInteger.csv")
metafile <- debugReadFile("C:/R_Projects/dfe-published-data-qa/tests/testthat/mainTests/indicator_dp_nonInteger.meta.csv")
