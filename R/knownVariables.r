...
expected_country_combinations <- unique(paste(
  countries$country_code,
  countries$country_name
))
expected_region_combinations <- unique(paste(
  regions$region_code,
  regions$region_name
))
...
expected_la_combinations <- unique(paste(
  las$old_la_code,
  las$new_la_code,
  las$la_name
))
expected_lad_combinations <- unique(paste(lads$lad_code, lads$lad_name))
expected_pcon_combinations <- unique(paste(
...
expected_eda_combinations <- unique(paste(
  edas$english_devolved_area_code,
...
harmonised_col_names <- suppressMessages(read_csv(
